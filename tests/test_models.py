...
class FakeLocator:
    ...
    def _matches(self):
        return [
            ...
            if i["role"] == self.role and adapter._named(i["name"], self.name)
        ]
    ...
    def click(self, timeout=None):
        self.page.acted.append(("click", self.role, self.name))
        self._activate()

    def press(self, key, timeout=None):
        self.page.acted.append(("press", self.role, self.name))
        self._activate()
