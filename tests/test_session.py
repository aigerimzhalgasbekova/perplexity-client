...
from perplexity_client import chrome
...
@pytest.mark.parametrize("title,url,authed,had_session,expected", [
    ("Perplexity", "https://www.perplexity.ai/", True, True, "ok"),
    ("Perplexity", "https://www.perplexity.ai/", False, True, "expired"),
    ("Perplexity", "https://www.perplexity.ai/", False, False, "no-session"),
    ...
    ("Just a moment...", "https://www.perplexity.ai/", False, True, "challenged"),
    ("Just a moment...", "https://www.perplexity.ai/", True, True, "challenged"),
    ("", "https://www.perplexity.ai/cdn-cgi/challenge-platform/x", True, True, "challenged"),
])
def test_classify(title, url, authed, had_session, expected):
    assert classify(title, url, authed, had_session) == expected
